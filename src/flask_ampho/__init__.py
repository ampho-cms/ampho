...
class Ampho:
    ...
    def _init_config(self):
        ...
        config_dir = self.app.config.get('AMPHO_CONFIG_DIR')
        if not config_dir:
            config_dir = self.app.config['AMPHO_CONFIG_DIR'] = default_config_dir
    ...
    def _init_logging(self):
        ...
        if not log_dir:
            log_dir = self.app.config['AMPHO_LOG_DIR'] = default_log_dir
